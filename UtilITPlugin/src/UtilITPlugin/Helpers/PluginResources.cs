namespace Loupedeck.UtilITPlugin
{
    using System;
    using System.IO;
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.UtilITPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.UtilITPlugin.Resources.Resource.txt`.
